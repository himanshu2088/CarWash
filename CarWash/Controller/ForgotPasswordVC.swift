...
class ForgotPasswordVC: UIViewController {
    ...
    let forgetPassImage: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "forgetpass")
        return imageView
    }()
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(forgetPassImage)
        forgetPassImage.translatesAutoresizingMaskIntoConstraints = false
        forgetPassImage.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 61.0).isActive = true
        forgetPassImage.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 25.0).isActive = true
        forgetPassImage.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: -25.0).isActive = true
        forgetPassImage.heightAnchor.constraint(equalToConstant: self.view.frame.height/2).isActive = true

        self.view.addSubview(emailTextField)
        emailTextField.translatesAutoresizingMaskIntoConstraints = false
        emailTextField.isUserInteractionEnabled = true
        emailTextField.topAnchor.constraint(equalTo: self.forgetPassImage.bottomAnchor, constant: 30.0).isActive = true
